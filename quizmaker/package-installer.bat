...
if exist src\main\resources\userdata\google-credentials.json (
    ...
    jpackage --input . --name Quizmaker --main-jar .\quizmaker-1.0-beta.jar --main-class org.ntnu.k2.g2.quizmaker.Main --icon .\classes\gui\media\quiz-logo-transparent.ico  --type exe --win-dir-chooser --vendor k2g2 --copyright k2g2 --win-menu --win-shortcut --win-upgrade-uuid 863281a1-ac73-44de-a77f-d0e6dd1fcd77 --app-version 1.0.0 || goto ERROR
