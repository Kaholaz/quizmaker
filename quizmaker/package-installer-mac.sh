...
then
    ...
    if ! jpackage --input . --name Quizmaker --main-jar quizmaker-1.0.0.jar --main-class org.ntnu.k2.g2.quizmaker.Main --icon classes/gui/media/quiz-logo-transparent.icns --vendor k2g2 --copyright k2g2 --type dmg --app-version 1.0.0; then error; fi
