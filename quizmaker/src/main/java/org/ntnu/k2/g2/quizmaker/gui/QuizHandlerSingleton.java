 ...
 * for whether the user has chosen an active or archived quiz. This is by default true (active).
 */
public class QuizHandlerSingleton {
     ...
     * if the currentQuiz is set or the active status is specified by using the setActive method.
     *
     ...
     * but changing the status is necessary. This will clear currentQuiz.
     * If changing the current quiz is necessary, use setQuiz instead.
     *
