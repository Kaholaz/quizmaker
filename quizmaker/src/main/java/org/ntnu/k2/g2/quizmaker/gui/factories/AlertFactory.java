...
public class AlertFactory {
    ...
    /**
     * Show a JOption warning. This is to be used if something wrong
     * happens before or during the initialization of the GUI
     * @param string The string to show on the warning.
     */
