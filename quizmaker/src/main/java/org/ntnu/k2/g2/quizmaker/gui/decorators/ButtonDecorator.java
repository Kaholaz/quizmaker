...
/**
 * Decorates buttons. If buttons are already instantiated this class can be used to style them differently. The
 * decorator uses mainly only css style classes. Swing methods should not be used for a better consistency. All methods
 * are static.
 */
public class ButtonDecorator {
     ...
     *
     * @param button
     *            button that is being decorated
     */
    ...
    /**
     * Changes the style of the class to a default delete button. This method clears the css-class of the button and
     * adds the class 'button-delete'
     *
     * @param button
     *            button that should be decorated
     */
    ...
    /**
     * Changes the style of the class to a default green button. This method clears the css-class of the button and adds
     * the class 'button-green'
     *
     * @param button
     *            button that should be decorated
     */
