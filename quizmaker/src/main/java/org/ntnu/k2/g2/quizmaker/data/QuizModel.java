...
public class QuizModel {
    ...
    public String toString() {
        return "Quiz{" + "id=" + id + ", name='" + name + '\'' + ", sheetId='" + sheetId + '\'' + ", active=" + active
                + ", lastChanged=" + lastChanged + ", teams=" + teams.values() + ", questions=" + questions.values()
                + '}';
    }

    /**
     * Checks the equality of two quizzes. All parameters and all contents of the parameters are considered. Order of
     * the question or teams does not matter as they are stored as HashMaps.
     *
     * @param o
     *            The quiz to compare to.
     *
    ...
    /**
     * Sets the last time this object was changed. This is set by the QuizDAO when the object is retrieved, and changed
     * whenever the entry in the database is altered.
     *
     * @param lastChanged
     *            The last time this object was altered.
     */
    ...
    /**
     * Gets the current collection of teams. If this HashMap is altered, and QuizRegister::saveQuiz is called, The
     * changes made WILL be reflected in the database. In the HashMap, the key is the id of the team, while the value is
     * the team object.
     *
    ...
    public Iterator<TeamModel> getTeamsSortedByScore() {
        return teams.values().stream().sorted(Comparator.comparingDouble(TeamModel::getScore).reversed()).iterator();
    }
     ...
     *
     * @param teams
     *            The new HashMap of the teams. The key is the id of the team, while the value is the corresponding team
     *            object.
     */
    ...
    /**
     * Gets the current collection of questions. If this HashMap is altered, and QuizRegister::saveQuiz is called, The
     * changes made WILL be reflected in the database. In the HashMap, the key is the id of the question, while the
     * value is the question object.
     *
     ...
     *
     * @param questions
     *            The new HashMap of the teams. The key is the id of the question, while the value is the corresponding
     *            question object.
     */
     ...
     *
     * @param active
     *            Whenever or not this quiz is active.
     */
    ...
    /**
     * @return The difficulty on a scale from 0 (hardest) to 1 (easiest) if no teams are registered to this quiz, -1 is
     *         returned.
     */
