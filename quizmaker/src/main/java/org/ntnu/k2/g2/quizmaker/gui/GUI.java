...
public class GUI extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.getIcons()
                .add(new Image(String.valueOf(GUI.class.getResource("/gui/media/quiz-logo-transparent.png"))));
     ...
     *
     * @param node
     *            A nod that can extract the current stage.
     * @param path
     *            The path for the FXML sheet for the next scene.
     */
    ...
    /**
     * Create a new stage (window). The path should be expressed relative to the 'resources' folder.
     *
     * @param path
     *            The path for the FXML document for the next scene.
     */
    ...
    /**
     * Change the scene of a given stage. The path should be expressed relative to the 'resources' folder.
     *
     * @param stage
     *            The stage to swap the scene of.
     * @param path
     *            The path of the FXML page of the new scene relative to the 'resources' folder.
     */
     ...
     * node to extract the stage from. The path should be expressed relative to the 'resources' folder.
     *
     * @param actionEvent
